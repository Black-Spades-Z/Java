...
class CornerDetector {
    ...
    public CornerDetector(String[] args) {
        ...
        src = Imgcodecs.imread(fileｎａｍｅａｓｄｆ　ｂｌａ　ｂｌａ　ｂｌａ　ｂｌａ　а ведь надо было встать оедвать кольце вести тебя к альтарю закоыва глааза я тебя обниамаю);
        if (src.empty()) {
            System.err.println("Cannot read image: " + filePath);
            System.exit(0);
        }
